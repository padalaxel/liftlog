...
export default function Home() {
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-md flex-col justify-center gap-3 p-5">
      ...
      <Link className="rounded-md bg-zinc-100 px-4 py-3 text-center text-sm font-semibold text-zinc-900" href="/auth">
        Sign in
      </Link>
      <Link className="rounded-md bg-zinc-800 px-4 py-3 text-center text-sm font-semibold text-zinc-200" href="/today?demo=1">
